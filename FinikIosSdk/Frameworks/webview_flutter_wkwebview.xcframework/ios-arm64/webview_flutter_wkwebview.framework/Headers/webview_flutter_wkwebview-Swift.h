...
#ifndef WEBVIEW_FLUTTER_WKWEBVIEW_SWIFT_H
#define WEBVIEW_FLUTTER_WKWEBVIEW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="webview_flutter_wkwebview",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class WKWebView;
/// App and package facing native API provided by the <code>webview_flutter_wkwebview</code> plugin.
...
SWIFT_CLASS_NAMED("FWFWebViewFlutterWKWebViewExternalAPI")
@interface FWFWebViewFlutterWKWebViewExternalAPI : NSObject
/// Retrieves the <code>WKWebView</code> that is associated with <code>identifier</code>.
/// See the Dart method <code>WebKitWebViewController.webViewIdentifier</code> to get the identifier of an
/// underlying <code>WKWebView</code>.
+ (WKWebView * _Nullable)webViewForIdentifier:(int64_t)identifier withPluginRegistry:(id <FlutterPluginRegistry> _Nonnull)registry SWIFT_WARN_UNUSED_RESULT;
...
/// Implementation of <code>WKNavigationDelegate</code> that calls to Dart in callback methods.
SWIFT_CLASS("_TtC25webview_flutter_wkwebview22NavigationDelegateImpl")
@interface NavigationDelegateImpl : NSObject <WKNavigationDelegate>
...
SWIFT_CLASS("_TtC25webview_flutter_wkwebview20WebViewFlutterPlugin")
